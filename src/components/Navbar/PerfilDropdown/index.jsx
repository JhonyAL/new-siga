...
export default function PerfilDropdown({ perfil }) {
  ...
  return (
    <div className="absolute shadow rounded-lg top-14 right-0 my-5 bg-white w-64 before:content-[''] before:-top-2.5 before:border-b-white before:border-x-transparent before:border-solid  before:right-0 before:absolute perfilDropdown">
